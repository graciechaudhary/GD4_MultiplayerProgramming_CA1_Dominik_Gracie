    ...
    m_scoreboard()
{
    ...
    m_scoreboard.setCharacterSize(70);
    Utility::CentreOrigin(m_scoreboard);
    m_scoreboard.setPosition(0.5f * view_size.x, 0.4f * view_size.y);
    ...
    m_instruction_text.setPosition(0.52f * view_size.x, 0.9f * view_size.y);
}
